...
export const customersGrid = [
  ...
  { field: 'prog_cour_level',
    headerText: 'Progress Level',
    width: '150',
    textAlign: 'Center' }
...
export const earningData = [
  //JAVA
  {
   ...
   name: 'Java',
    level: 'Beginner',
    desc: 'A beginner developer is someone who is just starting out in their programming journey. They are learning the fundamentals of coding and are likely to be working on basic coding exercises or small projects. They may not yet be familiar with more advanced programming concepts or industry-standard tools and practices.',
    iconColor: '#03C9D7',
    iconBg: '#E5FAFB',
...

  {
   ...
   name: 'Java',
    ...
    desc: 'An advanced beginner developer has some experience in coding and has completed several small coding projects. They are familiar with the basics of programming languages and may have some knowledge of industry-standard tools and practices. However, they still need guidance and mentorship to work on more complex coding tasks.',
    iconColor: '#03C9D7',
    iconBg: '#E5FAFB',
    pcColor: 'green-600',
  },
  {
   ...
   name: 'Java',
    level: 'Intermediate',
    desc: ' An intermediate developer has gained proficiency in coding and has completed multiple coding projects. They are familiar with a range of programming languages, frameworks, and tools, and can work independently on coding tasks. They have a solid understanding of coding concepts and are comfortable working with larger codebases.',
    iconColor: '#03C9D7',
    iconBg: '#E5FAFB',
    pcColor: 'green-600',
  },
  {
   ...
   name: 'Java',
    level: 'Advanced',
    desc: ' An advanced developer has extensive experience in coding and has worked on complex coding projects. They have a deep understanding of programming concepts and are comfortable using a range of programming languages, frameworks, and tools. They can work independently on complex coding tasks and are often sought after for their expertise.',
    iconColor: '#03C9D7',
    iconBg: '#E5FAFB',
    pcColor: 'green-600',
  },
  {
   ...
   name: 'Java',
    level: 'Expert',
    desc: 'An expert developer has exceptional skills and experience in coding and is a recognized leader in their field. They have made significant contributions to the development community, are highly proficient in multiple programming languages, and have a deep understanding of advanced programming concepts.',
    iconColor: '#03C9D7',
    iconBg: '#E5FAFB',
    pcColor: 'green-600',
  },
...
>>>>>>> 7fd8e84ec0baf45b54654508a48abd7d77fc7541
  { field: 'CustomerName',
...
export const scheduleData = [
  {
    Id: 1,
    Subject: 'Capathon Final Presentation',
    Location: 'Teams Meeting',
    StartTime: '2023-12-13T10:30:00.000Z',
    EndTime: '2023-12-13T13:00:00.000Z',
    CategoryColor: '#1aaa55',
  },
  {
    Id: 2,
    Subject: 'End Year Function',
    Location: 'Auditorium',
    StartTime: '2023-12-14T10:30:00.000Z',
    EndTime: '2023-12-14T10:30:00.000Z',
...
export const kanbanData = [
  {
    ...
    Title: 'Task - 29001',
    Status: 'Open',
    Summary: 'Analyze the new requirements for the upcoming website presentation.',
    Type: 'Story',
    Priority: 'Low',
  ...
  },
  {
    ...
    Title: 'Task - 29002',
    Status: 'InProgress',
    Summary: 'Perfom Search Engine Optimisation',
    Type: 'Improvement',
    Priority: 'Normal',
    Tags: 'Improvement',
    Estimate: 6,
  ...
  },
  {
    ...
    Title: 'Task - 29003',
    Status: 'Open',
    Summary: 'Practise presentation skills.',
    Type: 'Others',
    Priority: 'Critical',
    Tags: 'Meeting',
    Estimate: 5.5,
  ...
  },
  {
    ...
    Title: 'Task - 29004',
    Status: 'InProgress',
    Summary: 'Make the website responsive.',
    Type: 'Bug',
    Priority: 'Critical',
    Tags: 'IE',
    Estimate: 2.5,
